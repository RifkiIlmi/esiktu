...
CREATE TABLE IF NOT EXISTS `esiktu`.`pengalaman_kerja` (
  `id_pengalaman_kerja` INT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `esiktu`.`PNS` (
  `id_PNS` INT NOT NULL AUTO_INCREMENT,
  ...
  PRIMARY KEY (`id_PNS`, `fk_id_pangkat`, `fk_id_golongan`, `fk_id_pengalaman_kerja`, `fk_NIP`),
...
-- -----------------------------------------------------
-- Table `esiktu`.`pendidikan_formalaas`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `esiktu`.`pendidikan_formal` ;

CREATE TABLE IF NOT EXISTS `esiktu`.`pendidikan_formal` (
  `id_profesi_formal` INT NULL AUTO_INCREMENT,
  `pendidikan` VARCHAR(45) NOT NULL,
  `PNS_id_PNS` INT NOT NULL,
  PRIMARY KEY (`id_profesi_formal`),
  INDEX `fk_pendidikan_formal_PNS1_idx` (`PNS_id_PNS` ASC) ,
  CONSTRAINT `fk_pendidikan_formal_PNS1`
    FOREIGN KEY (`PNS_id_PNS`)
    REFERENCES `esiktu`.`PNS` (`id_PNS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `esiktu`.`pendidikan_J_T` (
  ...
  INDEX `fk_pendidikan_J_T_PNS1_idx` (`PNS_id_PNS` ASC) ,
  CONSTRAINT `fk_pendidikan_J_T_PNS1`
    FOREIGN KEY (`PNS_id_PNS`)
    REFERENCES `esiktu`.`PNS` (`id_PNS`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- Table `esiktu`.`skp`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `esiktu`.`skp` ;

CREATE TABLE IF NOT EXISTS `esiktu`.`skp` (
  `id_skp` INT NOT NULL AUTO_INCREMENT,
  `no_skp` VARCHAR(45) NOT NULL,
  `tgl_skp` VARCHAR(45) NOT NULL,
  `fk_id_honorer` INT NOT NULL,
  PRIMARY KEY (`id_skp`),
  INDEX `fk_skp_honorer1_idx` (`fk_id_honorer` ASC) ,
  CONSTRAINT `fk_skp_honorer1`
    FOREIGN KEY (`fk_id_honorer`)
    REFERENCES `esiktu`.`honorer` (`id_honorer`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
