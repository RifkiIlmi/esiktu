		...
		<div class="container-fluid">
			...
			<div class="card">
				...
				<div class="card-body">
					...
					<table id="kpangkat" class="table table-bordered table-striped text-center" style="width:100%">
						<thead>
							<tr>
								<th>No</th>
								<th>Nama</th>
						...
						<tbody>
							...
							<tr>
								...
								<td>Juru Muda Tk 1/Ib
									...
									<a href="<?php echo base_url('DataPegawai/updatePangkat/ib/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
									<?php endif;?>
								</td>
								<?php elseif($value->pangkat=='Juru Muda Tingkat 1'): ?>
								<td>Juru/Ic
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/ic/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Juru Tingkat 1/Id
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/id/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pengatur Muda/IIa
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iia/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pengatur Muda Tingkat 1/IIb
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iib/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pengatur/IIc
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iic/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pengatur Tingkat 1/IId
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iid/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Penata Muda/IIIa
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iiia/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Penata Muda Tingkat 1/IIIb
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iiib/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Penata/IIIc
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iiic/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Penata Tingkat 1/IIId
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iiid/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pembina/IVa
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/iva/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pembina Tingkat 1/IVb
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/ivb/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
								...
								<td>Pembina Utama Muda/IVc
									<?php if($now === $filter && $lastTglPangkat != $filter):?>
									<a href="<?php echo base_url('DataPegawai/updatePangkat/ivc/'). $value->id_PNS ?>">
										Naik Pangkat!</a>
									<?php endif;?>
									<?php if($lastTglPangkat == $filter):?>
									<i class="text-danger ml-2">Baru Naik Pangkat!</i>
