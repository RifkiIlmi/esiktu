						...
						<div class="active tab-pane" id="pns">
							<div class="card-header">
								<a href="<?php echo base_url('DataCuti/print_cuti_pns/').$filter?>"><button
										class="btn btn-md btn-success ml-0 m-2"><i class="fas fa-print"></i> Print Data
										cuti PNS to Excel</button></a>
							</div>
								...
								<tbody>
									...
									<tr>
										...
										<td class="text-center"><button class="btn btn-md btn-primary ml-0 m-2"
												data-toggle="modal" data-target="#cutipns<?= $value->id_cuti?>">
							...
							<table id="cutihnr" class="table table-bordered table-striped">
								...
								<tbody>
									...
									<tr>
										...
										<td><?= $value->jenis_cuti?></td>
										<td class="text-center"><button class="btn btn-md btn-primary ml-0 m-2"
												data-toggle="modal" data-target="#cutihonor<?= $value->id_cuti?>">
												<i class="fas fa-eye"></i></button></td>
										<td>
											<a
...
<div class="modal fade" id="cutipns<?= $value->id_cuti?>">
...
<div class="modal fade" id="cutihonor<?= $value->id_cuti?>">
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			<div class="modal-header">
				<h4 class="modal-title">Foto Hasil Scan</h4>
