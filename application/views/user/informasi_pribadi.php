					...
					<div class="row">
						...
						<div class="col-md-12">
							<div class="card card-secondary">
								<div class="card-header">
									<h3 class="card-title">Data Pengalaman / Pendidikan</h3>
								</div>
								<div class="card-body">
									<div class="row">
										<div class="col-sm-4">
							...
							<div class="modal-footer">
								<a href="<?php echo base_url('informasiPribadi/edit_lengkap_pns/').$id ?>"><button type="button"
					...
					<div class="card-body">
						<div class="row">
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<input type="text" disabled name="nama" value="<?= $honorer[0]->nama ?>"
										class="form-control">
									<input type="hidden" name="nama" value="<?= $honorer[0]->nama ?>" class="form-control">
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									...
									<input disabled type="text" name="NIP" value="<?= $honorer[0]->NIP ?>"
										class="form-control">
									<input type="hidden" name="NIP" value="<?= $honorer[0]->NIP ?>" class="form-control">
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<label>Tempat Lahir</label>
									<input disabled type="text" name="tempat_lahir" value="<?= $honorer[0]->tempat_lahir ?>"
										class="form-control">
							...
							<div class="col-sm-6">
								...
								<div class="form-group">
									<label>Tanggal Lahir</label>
									<input disabled type="date" name="tanggal_lahir" value="<?= $honorer[0]->tgl_lahir ?>"
										class="form-control">
							...
							<div class="col-sm-4">
								...
								<div class="form-group">
									...
									<input type="hidden" name="jabatan_honorer" value="<?= $honorer[0]->jabatan_honorer ?>"
										class="form-control">
								</div>
							</div>
							<div class="col-sm-4">
								...
								<div class="form-group">
									...
									<input disabled type="text" name="mengangkat" value="<?= $nama_PNS ?>"
										class="form-control">
									<input type="hidden" name="mengangkat" value="<?= $nama_PNS ?>" class="form-control">
								</div>
							</div>
						</div>
					</div>
